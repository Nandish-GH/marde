...
AIR MODEL LOCATION FOLLOW-UP: User answered 'blender'. Local discovery found six MARDE .blend files in C:/Users/mihir/Downloads. Most recently modified is MardeAirMain2.blend (September 7, 2026 17:13 Eastern; 945573 bytes), followed by MARDE_AIR_Main.blend (September 6). Other references: MARDE_AIR_Pass07_Primary_Structure_Redo.blend, MARDE_AIR_Pass08B_Aero_Electrical.blend, MARDE_Air_V1_Engineering_Geometry_Pass.blend and MARDE_Air_V1_Retractable_Gear_Concept.blend. Start by inspecting MardeAirMain2.blend read-only; recency alone does not prove it is the approved latest design. Preserve originals and check current Blender scene if accessible. No model geometry has yet been inspected in this follow-up.
