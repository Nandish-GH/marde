...
export function SystemGlyph({ type }: { type: string }) {
  return <svg viewBox="0 0 120 100" fill="none" stroke="currentColor" strokeWidth="1.4" aria-hidden="true">
    ...
    {type === "ground" ? <><path d="m28 37 32-16 33 17-32 18Z" fill="var(--glyph-fill, #172131)" /><path d="M28 37v28l33 18 32-17V38M61 56v27M38 44v19l12 7M73 55l12-6v15l-12 6" /><path d="M21 57 9 66v19l12 5 10-6V71M99 57l12 9v19l-12 5-9-6V71" /><path d="M38 21V9h14M83 24V10H70" /><circle cx="60" cy="40" r="4" /></> : null}
