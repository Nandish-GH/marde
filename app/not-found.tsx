...
export const metadata:Metadata={title:{absolute:"Page Not Found | MARDE"},description:"This MARDE page could not be found. Return to the homepage or contact the team.",openGraph:null,twitter:null,alternates:null};
